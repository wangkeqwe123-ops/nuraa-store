...
async function main(){
  ...
  for(const [index,item] of products.entries()){
    ...
    await db.productTranslation.update({where:{productId_locale:{productId:product.id,locale:"EN"}},data:{shortDescription:item.en.description,metaTitle:`${item.en.name} | NURAA`,metaDescription:item.en.description}});
    await db.productTranslation.update({where:{productId_locale:{productId:product.id,locale:"AR"}},data:{shortDescription:item.ar.description,metaTitle:`${item.ar.name} | NURAA`,metaDescription:item.ar.description}});
  }
