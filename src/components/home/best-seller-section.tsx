...
export function BestSellerSection({ locale, products }: { locale: Locale; products: StorefrontProduct[] }) { const { best }=getBrandContent(locale); return <section id="best-sellers" className="bg-[#fbfaf6] px-5 py-28 lg:px-10 lg:py-40"><div className="mx-auto max-w-[1500px]"><Reveal>
